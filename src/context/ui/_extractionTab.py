...
def showContourExtraction(callbacks):
    with dpg.group(horizontal=True):
        with dpg.child_window(width=300):
            ...
            dpg.add_input_double(tag='maxWidthMapping', width=-1, format="%.15g")
            ...
            dpg.add_input_double(tag='maxHeightMapping', width=-1, format="%.15g")
            ...
            dpg.add_input_double(tag='widthOffset', width=-1, format="%.15g")
            ...
            dpg.add_input_double(tag='heightOffset', width=-1, format="%.15g")
